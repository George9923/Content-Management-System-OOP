...
if(isset($_POST['submit'])){
    ...
    $new_comment =$commentOB ->create_comment($photo->id, $author,$body);

    if($new_comment && $new_comment->saveUser()){
...
$comments = $commentOB ->find_the_comments($photo->id);
